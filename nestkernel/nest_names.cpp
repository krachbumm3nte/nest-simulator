...
const Name apical_td_curr( "apical_td_curr" );
const Name apical_td_exc( "apical_td_exc" );
const Name apical_td_inh( "apical_td_inh" );
const Name apical_lat_curr( "apical_lat_curr" );
const Name apical_lat_exc( "apical_lat_exc" );
const Name apical_lat_inh( "apical_lat_inh" );
...
const Name b( "b" );
const Name basal_curr( "basal_curr" );
const Name basal_exc( "basal_exc" );
const Name basal_inh( "basal_inh" );
