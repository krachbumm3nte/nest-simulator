...
protected:
  /**
   * \fn void write_ubanczik_history( Time const& t_sp, double V_W, int n_spikes, int comp ))
   * Writes the history for compartment comp into the buffers.
   */
  void write_ubanczik_history( Time const& t_sp, double V_W, int n_spikes, int comp );
